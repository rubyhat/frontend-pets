      ...
      <div className="py-3">
        ...
        <div className="py-3">
          ...
          <p className="text-base font-medium text-zinc-600 mt-2">
            ...
            остаются доступными функции, и более никому. Поэтому это и
            называется замыкание, т.к. переменные замкнуты на саму функцию.
          </p>
          <p className="text-base font-medium text-zinc-600 mt-2">
            Другими словами, чтобы создать замыкание, необходимо вложить функцию
            в функцию, обратиться из вложенной функции к переменным
            оборачивающей и вложенную функцию вернуть наружу. До тех пор, пока
            возвращенная функция остается в доступе, замыкание существует.
          </p>
        </div>
        <div className="py-3">
